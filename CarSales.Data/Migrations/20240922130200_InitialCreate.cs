        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ServiceExitDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CarFix = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Email", "IsItActive", "Name", "Password", "Phone", "RoleId", "Surname", "UserCreateDate", "UserName" },
                values: new object[] { 1, "admin@otoservissatis.tc", true, "Admin", "123456", "0850", 1, "admin", new DateTime(2024, 9, 22, 16, 2, 0, 529, DateTimeKind.Local).AddTicks(44), "admin" });
