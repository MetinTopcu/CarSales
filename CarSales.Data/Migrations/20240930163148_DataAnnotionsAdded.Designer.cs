...
namespace CarSales.Data.Migrations
{
    ...
    [Migration("20240930163148_DataAnnotionsAdded")]
    partial class DataAnnotionsAdded
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CarSales.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RoleId = 1,
                            Surname = "admin",
                            UserCreateDate = new DateTime(2024, 9, 30, 19, 31, 48, 258, DateTimeKind.Local).AddTicks(3793),
                            UserName = "admin"
                        });
                });
